...
class Interior1 {
  ...
  AcAssembly? airbags;
  AcAssembly? clusterPanelAssembly;
  AcAssembly? dashboardAssembly;
  AcAssembly? frontWindshieldGlass;
  AcAssembly? seats;
...
class Interior2 {
  AcAssembly? audioStereoAssembly;
  AcAssembly? centreConsoleAssembly;
  AcAssembly? forwardParkingSensors;
  AcAssembly? frontLeftDoorAssembly;
  AcAssembly? frontRightDoorAssembly;
  AcAssembly? reverseParkingCamera;
  AcAssembly? reverseParkingSensors;
...
class LeftSide {
  ...
  AcAssembly? frontLeftMechanical;
...
class FrontLeftStructure {
  AcAssembly? leftFloorPanChannel;
  AcAssembly? leftPillarB;
  AcAssembly? leftPillarC;
  TRunningBoard? leftRunningBoard;
  AcAssembly? rearLeftDoorChannel;
  AcAssembly? rearLeftFloorPan;
  AcAssembly? rearLeftWheelHouse;
...
class RearExterior {
  ...
  AcAssembly? leftTailLightAssembly;
  AcAssembly? rearBumperPanel;
  AcAssembly? rearRegistrationPlate;
  AcAssembly? rearWindshieldGlass;
  AcAssembly? rightTailLightAssembly;
...
class RightSide {
  ...
  AcAssembly? rightRightMechanical;
...
class RearRightStructure {
  AcAssembly? rearRightDoorChannel;
  AcAssembly? rearRightFloorPan;
  AcAssembly? rearRightWheelHouse;
  AcAssembly? rightFloorPanChannel;
  AcAssembly? rightPillarB;
  AcAssembly? rightPillarC;
