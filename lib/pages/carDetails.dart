...
//Rear right door channel
  ...
  void _saveCarInspection() async {
    ...
    num carPrice = _carFairPriceController.text.isEmpty ? widget.carDetails.carCarPrice : num.parse(_carFairPriceController.text);
    setState(() {
    ...
    final carAuction = CarAuction(
      ...
      totalDistance: widget.carDetails.carDistanceTravelled,
      rtoNumber: widget.carDetails.carNumber,
      maxBidPrice: widget.carDetails.carCarPrice * 2,
      highestBid: 0.0,
    );
  ...
  Widget _buildInspectionPage() {
    return Form(
      ...
      child: ListView(
        padding: const EdgeInsets.all(16.0),
        children: [
          _buildCardExpansionTile('Battery', [
            SwitchListTile(
              title: const Text(
                'Aftermarket fitment',
              ),
          ...
          _buildCardExpansionTile('Engine', [
          ...
          _buildCardExpansionTile('Front Side', [
          ...
          _buildCardExpansionTile('Interior-1', [
          ...
          _buildCardExpansionTile('Interior-2', [
          ...
          _buildCardExpansionTile('Left side', [
          ...
          _buildCardExpansionTile('Rear side', [
          ...
          _buildCardExpansionTile('Right side', [
          ...
          _buildCardExpansionTile('Test Drive', [
            SwitchListTile(
              title: const Text(
                'Steering health',
              ),
